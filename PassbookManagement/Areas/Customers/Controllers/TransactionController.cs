...
namespace PassbookManagement.Areas.Customers.Controllers
{
    ...
    public class TransactionController : Controller
    {
        ...
        public TransactionController(PassBookManagementContext context)
        {
            _context = context;
        }

        // GET: Customers/Transaction
        ...
        // GET: Customers/Transaction/Details/5
        ...
        // GET: Customers/Transaction/Create
        ...
        // POST: Customers/Transaction/Create
        ...
        public async Task<IActionResult> Create([Bind("TransactionId,PassbookRefId,EmployeeRefId,TransactionMethod,TransactionType,Amount,IsViolation,ReleaseDate,SpendingAccountRefId")] Transaction transaction)
        {
            ...
            ViewData["EmployeeRefId"] = new SelectList(_context.Employee, "EmployeeId", "EmployeeId", transaction.EmployeeRefId);
        ...
        // GET: Customers/Transaction/Edit/5
        ...
        // POST: Customers/Transaction/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Customers/Transaction/Delete/5
        ...
        // POST: Customers/Transaction/Delete/5
